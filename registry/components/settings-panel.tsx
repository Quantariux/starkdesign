...
export function SettingsPanel() {
  ...
  return (
    <div className="flex flex-col md:flex-row gap-6 w-full max-w-4xl mx-auto rounded-xl border border-white/10 bg-zinc-950/60 backdrop-blur-md overflow-hidden shadow-2xl">
      {/* Sidebar Navigation */}
      <div className="w-full md:w-56 border-r border-white/5 p-4 space-y-1">
      ...
      <div className="flex-1 p-6 space-y-6">
        ...
        <GlassCard glow hoverGlow={false} className="border-violet-500/20">
          <GlassCardHeader>
          ...
          <GlassCardContent className="space-y-4">
            <div className="flex items-center gap-2 bg-black/40 border border-white/5 rounded-md p-2.5 font-mono text-xs text-zinc-300">
          ...
          <GlassCardFooter className="flex justify-end gap-2 border-t border-white/5 pt-4">
